...
```php
//...
use srag\RemovePluginDataConfirm\SrRestoreRoleTemplates\x\PluginUninstallTrait;
//...
...
```php
//...
use srag\RemovePluginDataConfirm\SrRestoreRoleTemplates\x\RepositoryObjectPluginUninstallTrait;
//...
