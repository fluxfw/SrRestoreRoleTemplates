...
```php
...
use srag\GeneratePluginInfosHelper\SrRestoreRoleTemplates\x\GeneratePluginPhpAndXml; 
...
...
```php
...
use srag\GeneratePluginInfosHelper\SrRestoreRoleTemplates\x\GeneratePluginReadme; 
...
...
```json
  ...
  "update-version": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrRestoreRoleTemplates\\x\\UpdateVersion::updateVersion"
    ]
  ...
```
...
```php
...
use srag\GeneratePluginInfosHelper\SrRestoreRoleTemplates\x\UpdateVersion; 
...
