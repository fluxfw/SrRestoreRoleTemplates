...
```json
  "pre-autoload-dump": [
    ...,
      "srag\\GeneratePluginInfosHelper\\SrRestoreRoleTemplates\\x\\GeneratePluginPhpAndXml::generatePluginPhpAndXml"
    ]
```
...
```json
  "pre-autoload-dump": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrRestoreRoleTemplates\\x\\GeneratePluginReadme::generatePluginReadme"
    ]
```
...
```json
  "pre-autoload-dump": [
    ...,
     "srag\\GeneratePluginInfosHelper\\SrRestoreRoleTemplates\\x\\UpdatePluginReadme::updatePluginReadme"
    ]
```
