...
```php
...
use srag\ActiveRecordConfig\SrRestoreRoleTemplates\x\Config\AbstractFactory;
use srag\ActiveRecordConfig\SrRestoreRoleTemplates\x\Config\AbstractRepository;
...
