...
namespace srag\CustomInputGUIs\SrRestoreRoleTemplates\PropertyFormGUI\Exception;
 ...
 *
 * @package srag\CustomInputGUIs\SrRestoreRoleTemplates\PropertyFormGUI\Exception
 *
 * @deprecated
 */
