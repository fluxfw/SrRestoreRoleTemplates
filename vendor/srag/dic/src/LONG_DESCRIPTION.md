...
```php
use srag\DIC\SrRestoreRoleTemplates\x\DICStatic;use srag\Plugins\x\x\x;DICStatic::dic()->database()->createAutoIncrement(x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\SrRestoreRoleTemplates\x\Version\PluginVersionParameter;
...
