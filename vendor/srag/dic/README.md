...
```php
\srag\DIC\SrRestoreRoleTemplates\x\DICStatic::dic()->database()->createAutoIncrement(\srag\Plugins\x\x\x::TABLE_NAME, "id");
```
...
```php
...
use srag\DIC\SrRestoreRoleTemplates\x\DevTools\DevToolsCtrl;
...
    /**
     * @inheritDoc
     */
...
/**
 * ...
 * @ilCtrl_isCalledBy srag\DIC\SrRestoreRoleTemplates\x\DevTools\DevToolsCtrl: ilXConfigGUI
 */
class ...
...
    /**
